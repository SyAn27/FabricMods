...
public class A implements ModInitializer
{
    ...
    public void onInitialize()
    {
        ...
        Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier("test_a", "test_block_entity"), BlockEntityType.Builder.create(TestBlockEntity::new, TEST_BLOCK).build(null));
