...
public class SingleContainer extends AbstractContainer
{
    ...
    static
    {
        ...
        SIZES = new HashMap<>();
        SIZES.put(27, ScreenMeta.of(9, 3, 27, id.apply(9, 3), 192, 192)); // Wood
        SIZES.put(54, ScreenMeta.of(9, 6, 54, id.apply(9, 6), 192, 240)); // Iron / Large Wood
        SIZES.put(81, ScreenMeta.of(9, 9, 81, id.apply(9, 9), 192, 304)); // Gold
