...
/**
 * Entry point for declaring different screen types and adding different sizes of screens.
 * Entry point ID: ninjaphenix-container-library-screens
...
{
    /**
     *  This is where you should register callbacks for when a screen size is registered.
     *  {@link ContainerLibraryAPI#declareScreenSizeRegisterCallback}
     */
