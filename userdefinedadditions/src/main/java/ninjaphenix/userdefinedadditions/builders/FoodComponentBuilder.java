...
public class FoodComponentBuilder implements Builder<FoodComponent>
{
    ...
    public FoodComponentBuilder hunger(int hunger)
    {
    ...
    public FoodComponentBuilder meat()
    {
        builder.meat();
        return this;
    }
    ...
    {
        builder.statusEffect(new StatusEffectInstance(effect, duration, amplifier, false, !hidden), chance);
        return this;
    }
